...
function createSection (section, content, options) {
  ...
  return {
    ...
    contents: phantom.callback(function (pageNum, numPages) {
      ...
      var pageOffset = (options.paginationStartPage > 1) ? options.paginationStartPage : 1
      var pageNumFinal = (pageNum - pageOffset > 0) ? pageNum - pageOffset : ''
      var numPagesFinal = numPages - (pageOffset - 1)
